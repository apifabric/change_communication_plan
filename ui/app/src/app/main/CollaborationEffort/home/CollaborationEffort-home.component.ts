...
@Component({
  selector: 'CollaborationEffort-home',
  templateUrl: './CollaborationEffort-home.component.html',
  styleUrls: ['./CollaborationEffort-home.component.scss']
})
export class CollaborationEffortHomeComponent implements AfterViewInit {
