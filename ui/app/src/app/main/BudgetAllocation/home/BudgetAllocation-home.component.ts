...
@Component({
  selector: 'BudgetAllocation-home',
  templateUrl: './BudgetAllocation-home.component.html',
  styleUrls: ['./BudgetAllocation-home.component.scss']
})
export class BudgetAllocationHomeComponent implements AfterViewInit {
