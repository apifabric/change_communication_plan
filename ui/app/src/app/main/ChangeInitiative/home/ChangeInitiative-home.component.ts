...
@Component({
  selector: 'ChangeInitiative-home',
  templateUrl: './ChangeInitiative-home.component.html',
  styleUrls: ['./ChangeInitiative-home.component.scss']
})
export class ChangeInitiativeHomeComponent implements AfterViewInit {
