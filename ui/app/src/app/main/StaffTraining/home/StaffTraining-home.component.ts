...
@Component({
  selector: 'StaffTraining-home',
  templateUrl: './StaffTraining-home.component.html',
  styleUrls: ['./StaffTraining-home.component.scss']
})
export class StaffTrainingHomeComponent implements AfterViewInit {
