...
@Component({
  selector: 'ResistanceMitigation-home',
  templateUrl: './ResistanceMitigation-home.component.html',
  styleUrls: ['./ResistanceMitigation-home.component.scss']
})
export class ResistanceMitigationHomeComponent implements AfterViewInit {
