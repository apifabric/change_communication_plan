...
@Component({
  selector: 'ChangeOutcome-home',
  templateUrl: './ChangeOutcome-home.component.html',
  styleUrls: ['./ChangeOutcome-home.component.scss']
})
export class ChangeOutcomeHomeComponent implements AfterViewInit {
