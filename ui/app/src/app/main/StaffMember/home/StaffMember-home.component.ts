...
@Component({
  selector: 'StaffMember-home',
  templateUrl: './StaffMember-home.component.html',
  styleUrls: ['./StaffMember-home.component.scss']
})
export class StaffMemberHomeComponent implements AfterViewInit {
