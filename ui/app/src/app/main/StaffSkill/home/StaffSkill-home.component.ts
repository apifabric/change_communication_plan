...
@Component({
  selector: 'StaffSkill-home',
  templateUrl: './StaffSkill-home.component.html',
  styleUrls: ['./StaffSkill-home.component.scss']
})
export class StaffSkillHomeComponent implements AfterViewInit {
